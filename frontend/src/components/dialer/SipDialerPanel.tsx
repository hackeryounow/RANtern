/**
 * SipDialerPanel — the browser SIP softphone (Asterisk / WebSocket).
 *
 * Left: SIP registration config + call metrics.
 * Center: number display + VoxEra-style circular keypad + call controls.
 * Right: SIP status + SIP logs.
 * Embedded by the unified Dialer page (SIP mode).
 */
...
export default function SipDialerPanel() {
  const sip = useSip();
  ...
  return (
    <div style={{ display: 'flex', gap: 16, height: 'calc(100vh - 160px)', minHeight: 560 }}>
      ...
      <div style={{ width: 300, display: 'flex', flexDirection: 'column', gap: 12, flexShrink: 0, overflowY: 'auto' }}>
        ...
        <Card size="small" style={glassCard} styles={{ body: { padding: '16px 18px' } }}
          title={
            <Space>
        ...
        } style={glassCard} styles={{ body: { padding: '14px 18px' } }}>
          <Space direction="vertical" style={{ width: '100%' }} size="small">
            {[
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 16, minWidth: 0, alignItems: 'center', justifyContent: 'center' }}>
        ...
        {sip.callStatus !== 'idle' && sip.callStatus !== 'ended' && sip.callStatus !== 'incoming' && (
          <Card size="small" style={{ ...glassCard, width: '100%', maxWidth: 420, borderColor: `${callStatusColor}25` }} styles={{ body: { padding: '14px 18px' } }}>
      ...
      <div style={{ width: 340, display: 'flex', flexDirection: 'column', gap: 12, flexShrink: 0, overflowY: 'auto' }}>
        ...
        } style={{ ...glassCard, flex: 1, minHeight: 180 }} styles={{ body: { padding: '10px 14px' } }}
